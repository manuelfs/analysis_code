...
int main(){ 
  ...
  ///////////////////////////////////    Dilepton ID    //////////////////////////////////////////////
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  baseline = "(trig[28]||trig[33]||trig[11]||trig[12])&&ht>300&&mumuv_pt>200&&mumuv_m>60&&njets>=3";

  cout<<endl<<"=========  HT: VVVL, IsoMu22, Mu50  for HT>300 =========="<<endl;
  Efficiency(&c_hadll, baseline, "trig[4]");
  Efficiency(&c_hadll, baseline, "trig[32]");
  Efficiency(&c_hadll, baseline, "trig[21]");

  baseline = "(trig[28]||trig[33]||trig[11]||trig[12])&&ht>500&&elelv_pt>200&&elelv_m>60&&njets>=3";
  cout<<endl<<"=========  HT: VVVL, Ele25, Ele27  for HT>500  =========="<<endl;
  ...
  cout<<endl<<"=========  HT: VVVL, IsoMu22, Mu50  for HT>250 =========="<<endl;
  Efficiency(&c_hadll, baseline, "trig[4]");
  Efficiency(&c_hadll, baseline, "trig[32]");
  Efficiency(&c_hadll, baseline, "trig[21]");

  baseline = "(trig[28]||trig[33]||trig[11]||trig[12])&&ht>250&&elelv_pt>200&&elelv_m>60&&njets>=3";
  cout<<endl<<"=========  HT: VVVL, Ele25, Ele27  for HT>250  =========="<<endl;
  Efficiency(&c_hadll, baseline, "trig[8]");
  Efficiency(&c_hadll, baseline, "trig[23]");
  Efficiency(&c_hadll, baseline, "trig[22]");
  ...
  cout<<endl<<"=========  MET: VVVL, IsoMu22, Mu50  for 250<HT<900  =========="<<endl;
  ...
  cout<<endl<<"=========  MET: VVVVL, Ele25, Ele27  for 250<HT<900  =========="<<endl;
  ...
  PlotTurnOn(&c_ht900, "mht", nbins,minx,maxx, "H_{T}^{miss}",
	     "trig[12]&&njets>=3&&mht/met<5&&nvmus==0&&nvels==0&&met/met_calo<5&&!low_dphi", 
	     "((trig[13]||trig[33]))", "HT800, H_{T}>900,N_{l}=0,N_{j}#geq3,PF/calo<5", "MHT100 || MHTNoMu100");
  PlotTurnOn(&c_ht900, "mht", nbins,minx,maxx, "H_{T}^{miss}",
	     "trig[12]&&njets>=3&&mht/met<5&&nvmus==0&&nvels==0&&met/met_calo<2&&!low_dphi", 
	     "((trig[13]||trig[33]))", "HT800, H_{T}>900,N_{l}=0,N_{j}#geq3,PF/calo<2", "MHT100 || MHTNoMu100");
  PlotTurnOn(&c_ht900, "mht", nbins,minx,maxx, "H_{T}^{miss}",
	     "trig[12]&&njets>=3&&mht/met<5&&nvmus==0&&nvels==0&&!low_dphi", 
	     "((trig[13]||trig[33]))", "HT800, H_{T} > 900, N_{l} = 0, N_{jet} #geq 3", "MHT100 || MHTNoMu100");
  ...
  baseline = "trig[12]&&njets>=3&&mht/met<5&&nvmus==0&&nvels==0&&met/met_calo<5";
  cout<<endl<<"=========  MHT100 fake MHT PF/calo < 5 =========="<<endl;
  Efficiency(&c_ht900, baseline+"&&mht>250&&mht<=300", "(trig[13]||trig[33])");
  Efficiency(&c_ht900, baseline+"&&mht>300&&mht<=500", "(trig[13]||trig[33])");
  Efficiency(&c_ht900, baseline+"&&mht>500",           "(trig[13]||trig[33])");

  baseline = "trig[12]&&njets>=3&&mht/met<5&&nvmus==0&&nvels==0&&met/met_calo<2";
  cout<<endl<<"=========  MHT100 fake MHT PF/calo < 2 =========="<<endl;
  Efficiency(&c_ht900, baseline+"&&mht>250&&mht<=300", "(trig[13]||trig[33])");
  Efficiency(&c_ht900, baseline+"&&mht>300&&mht<=500", "(trig[13]||trig[33])");
  Efficiency(&c_ht900, baseline+"&&mht>500",           "(trig[13]||trig[33])");

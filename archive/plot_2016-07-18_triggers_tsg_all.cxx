...
int main(){ 
  ...
  minx = 10; maxx = 40; nbins = static_cast<int>((maxx-minx)/1);
  PlotTurnOn(&c_met, "Max$(mus_pt*(mus_sigid&&mus_miniso<0.2))", nbins,minx,maxx, "Muon p_{T}",
	     "trig[33]&&onht>400&&ht>450&&njets>=2&&met>"+metcut, "trig[3]||trig[4]",
	     "MET100, H_{T}>450, N_{jet}#geq2, MET>"+metcut, "Mu15_HT400",-1,1,true,false);
  // Electron, VVVL, fine binning
  PlotTurnOn(&c_met, "Max$(els_pt*(els_sigid&&els_miniso<0.1))", nbins,minx,maxx, "Electron p_{T}",
	     "trig[33]&&onht>400&&ht>450&&njets>=2&&met>"+metcut, "trig[7]||trig[8]",
	     "MET100, H_{T}>450, N_{jet}#geq2, MET>"+metcut, "Ele15_HT400",-1,1,true,false);
  ...
  // VVVL: HT400
  minx = 140; maxx = 830; nbins = static_cast<int>((maxx-minx)/10);
  PlotTurnOn(&c_met, "ht_hlt", nbins,minx,maxx, "H_{T}^{HLT} with leptons and |#eta|<3",
	     "trig[13]&&met>300&&njets>=2&&Max$(els_vvvl)&&nvels>=1&&run>=274960", "trig[7]",
	     "1.5fbMET100, N_{e}#geq1, N_{jet}#geq2, MET>300", "Ele15_HT400", 300,1,true,false);
  PlotTurnOn(&c_met, "ht", nbins,minx,maxx, "H_{T} with no leptons and |#eta|<2.4",
	     "trig[13]&&met>300&&njets>=2&&Max$(els_vvvl)&&nvels>=1&&run>=274960", "trig[7]",
	     "1.5fbMET100, N_{e}#geq1, N_{jet}#geq2, MET>300", "Ele15_HT400", 300,1,true,false);
  PlotTurnOn(&c_met, "ht_ra2", nbins,minx,maxx, "H_{T} with leptons and |#eta|<2.4",
	     "trig[13]&&met>300&&njets>=2&&Max$(els_vvvl)&&nvels>=1&&run>=274960", "trig[7]",
	     "1.5fbMET100, N_{e}#geq1, N_{jet}#geq2, MET>300", "Ele15_HT400", 400,1,true,false);
  ...
  PlotTurnOn(&c_mu, mindp, nbins,minx,maxx, "#Delta#phi(E_{T}^{miss},#mu)",
	     "trig[32]&&Max$(mus_pt*(mus_miniso<0.2&&mus_sigid))>25&&njets>=4&&met>250&&nmus==1", "(trig[13]||trig[33])",  
	     "IsoMu22, N_{#mu}#geq1, N_{jet}#geq4, E_{T}^{miss}>250", "MHT100 || MHTNoMu100",0);

  minx = 0; maxx = 520; nbins = static_cast<int>((maxx-minx)/10);
  // MET100 or METNoMu100
  PlotTurnOn(&c_mu, "met", nbins,minx,maxx, "E_{T}^{miss}",
	     "trig[32]&&Max$(mus_pt*(mus_miniso<0.2&&mus_sigid))>25&&njets>=4&&ht>500", "(trig[13])",  
	     "IsoMu22, N_{#mu,25} #geq 1, N_{jet} #geq 4", "MET100",100);
  PlotTurnOn(&c_mu, "met", nbins,minx,maxx, "E_{T}^{miss}",
	     "trig[32]&&Max$(mus_pt*(mus_miniso<0.2&&mus_sigid))>25&&njets>=4&&ht>500", "(trig[33])",  
	     "IsoMu22, N_{#mu,25} #geq 1, N_{jet} #geq 4", "METNoMu100",100);
  PlotTurnOn(&c_mu, "met", nbins,minx,maxx, "E_{T}^{miss}",
  ...
  PlotTurnOn(&c_el, "met", nbins,minx,maxx, "E_{T}^{miss}",
	     "trig[23]&&onht>400&&ht>400&&Max$(els_pt*(els_miniso<0.1&&els_sigid))>25&&njets>=4&&ht>500&&nvmus==0", "(trig[0])",      
	     "Ele25_WPTight, N_{e,25} #geq 1, N_{jet} #geq 4", "HT300_MET100");
  ...
  PlotTurnOn(&c_el, "met", nbins,minx,maxx, "E_{T}^{miss}",
	     "trig[23]&&Max$(els_pt*(els_miniso<0.1&&els_sigid))>25&&njets>=4&&ht>500&&nvmus==0", "(trig[33])",      
	     "Ele25_WPTight, N_{e,25} #geq 1, N_{jet} #geq 4", "METNoMu100");
  PlotTurnOn(&c_el, "met", nbins,minx,maxx, "E_{T}^{miss}",
	     "trig[23]&&Max$(els_pt*(els_miniso<0.1&&els_sigid))>25&&njets>=4&&ht>500&&nvmus==0", "(trig[13])",      
	     "Ele25_WPTight, N_{e,25} #geq 1, N_{jet} #geq 4", "MET100");

  // MET110 or METNoMu110
  PlotTurnOn(&c_el, "met", nbins,minx,maxx, "E_{T}^{miss}",
	     "trig[23]&&Max$(els_pt*(els_miniso<0.1&&els_sigid))>25&&njets>=4&&ht>500&&nvmus==0", "(trig[14]||trig[15])",      
	     "Ele25_WPTight, N_{e,25} #geq 1, N_{jet} #geq 4", "MET110 || METNoMu110");
  PlotTurnOn(&c_el, "met", nbins,minx,maxx, "E_{T}^{miss}",
	     "trig[23]&&Max$(els_pt*(els_miniso<0.1&&els_sigid))>25&&njets>=4&&ht>500&&nvmus==0", "(trig[15])",      
	     "Ele25_WPTight, N_{e,25} #geq 1, N_{jet} #geq 4", "METNoMu110");
  PlotTurnOn(&c_el, "met", nbins,minx,maxx, "E_{T}^{miss}",
	     "trig[23]&&Max$(els_pt*(els_miniso<0.1&&els_sigid))>25&&njets>=4&&ht>500&&nvmus==0", "(trig[14])",      
	     "Ele25_WPTight, N_{e,25} #geq 1, N_{jet} #geq 4", "MET110");
  ...
  PlotTurnOn(&c_met, "ht", nbins,minx,maxx, "H_{T}",
	     "trig[13]&&nvleps==0&&met>200&&njets>=4", "trig[0]",
	     "MET100, N_{e,10}=0, N_{jet}#geq2, MET>200", "HT300_MET100",280,1,true,false);

...
int main(){ 
  ...
  TString trigmu = "(trig[3]||trig[20]||trig[21])";
  TString trigel = "(trig[7]||trig[23]||trig[24])";
  TString trigmetmu = "("+trigmet+"||"+trigmu+")";
  TString trigmetel = "("+trigmet+"||"+trigel+")";
  ...
  PlotTurnOn(&c_mu, "met", nbins,minx,maxx, "E_{T}^{miss}",
             "trig[49]&&nmus==1&&run>="+runvvvl+"&&njets>=3&&ht>550", trigmetmu, 
             "3.77fbJet500, N_{#mu} = 1, N_{jet} #geq 3, H_{T} > 550", "MET120 || Muon", -200);
  // MET or Single Electron
  PlotTurnOn(&c_el, "met", nbins,minx,maxx, "E_{T}^{miss}",
	     "trig[49]&&nels==1&&run>="+runvvvl+"&&njets>=3&&ht>550", trigmetel, 
             "3.77fbJet500, N_{e} = 1, N_{jet} #geq 3, H_{T} > 550", "MET120 || Electron", -200);
  // MET120 or METNoMu120 Muon
  PlotTurnOn(&c_mu, "met", nbins,minx,maxx, "E_{T}^{miss}",
	     "trig[49]&&nmus>=1&&run>="+runvvvl+"&&njets>=3&&ht>550", trigmet, 
	     "3.77fbJet500, N_{#mu} #geq 1, N_{jet} #geq 3, H_{T} > 550", "MET120",-200);
  // MET120 or METNoMu120 Electron
  PlotTurnOn(&c_el, "met", nbins,minx,maxx, "E_{T}^{miss}",
	     "trig[49]&&nels>=1&&run>="+runvvvl+"&&njets>=3&&ht>550", trigmet, 
             "3.77fbJet500, N_{e} #geq 1, N_{jet} #geq 3, H_{T} > 550", "MET120", -200);
  ...
  PlotTurnOn(&c_met, "Max$(mus_pt*(mus_sigid&&mus_miniso<0.2))", nbins,minx,maxx, "Muon p_{T}",
	     ...
	     "3.77fbMET120, H_{T}>550, N_{jet}#geq1, MET>"+metcut, "Mu15_HT450",13,1,true,false);
  ...
  PlotTurnOn(&c_met, "Max$(els_pt*(els_sigid&&els_miniso<0.1))", nbins,minx,maxx, "Electron p_{T}",
	     ...
	     "3.77fbMET120, H_{T}>550, N_{jet}#geq1, MET>"+metcut, "Ele15_HT450",13,1,true,false);

  //minx = 20; maxx = 65; nbins = static_cast<int>((maxx-minx)/1);
  // Muon, Isomu27, fine binning
  PlotTurnOn(&c_met, "Max$(mus_pt*(mus_sigid&&mus_miniso<0.2))", nbins,minx,maxx, "Muon p_{T}",
	     trigmet+"&&njets>=1&&met>"+metcut, "trig[20]",
	     "MET120, N_{jet}#geq1, MET>"+metcut, "IsoMu27",28,1,true,false);
  // Electron, Ele35, fine binning
  PlotTurnOn(&c_met, "Max$(els_pt*(els_sigid&&els_miniso<0.1))", nbins,minx,maxx, "Electron p_{T}",
	     trigmet+"&&njets>=1&&met>"+metcut, "trig[23]",
	     "MET120, N_{jet}#geq1, MET>"+metcut, "Ele35_WPTight",37,1,true,false);
  ...
  PlotTurnOn(&c_met, "Max$(mus_pt*(mus_sigid&&mus_miniso<0.2))", nbins,minx,maxx, "Muon p_{T}",
	     ...
	     "MET120, N_{jet}#geq1, MET>"+metcut, "Mu50",49,1,true,false);
...
TString PlotTurnOn(TChain *data, TString var, int nbins, double minx, double maxx, TString xtitle, 
  ...
  can.SetGrid();
  TH1D* histo[2];
  TString passcuts = "&&pass_hbhe&&pass_hbheiso&&pass_goodv&&pass_ecaldeadcell&&pass_eebadsc";

...
int main(){ 
  ...
  TChain c_met("tree"); 
  c_met.Add(folder17+"/merged_database_metG200__pass/*.root"); 
  c_met.Add(folder14+"/merged_database_met200/*.root"); 

  TChain c_el("tree"); 
  c_el.Add(folder17+"/merged_database_nelsGE1__njetsGE3__pass/*.root"); 

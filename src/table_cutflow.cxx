...
int main(){
  ...
  TString folder="/cms2r0/babymaker/babies/2015_10_19/mc/";
  vector<TString> s_tt;
  ...
  Samples.push_back(sfeats(s_qcd, "QCD", 1002));
  ...
  tables.back().add("$N_{\\rm b}\\geq2$", "nbm>=2&&njets>=6&&met>200&&ht>500&&nleps==1");
  tables.back().add("$M_J>250$ GeV", "mj>250&&nbm>=2&&njets>=6&&met>200&&ht>500&&nleps==1","-");

...
int main(){ 
  ...
  PlotTurnOn(&c_el, "met", nbins,minx,maxx, "E_{T}^{miss}",
    ...
    PlotTurnOn(&c_met, "Max$(mus_pt*(mus_sigid&&mus_miniso<0.2))", nbins,minx,maxx, "Muon p_{T}",
    	       "trig[33]&&onht>400&&ht>500&&njets>=3&&met>"+metcut, "trig[3]||trig[4]",
    	       "MET100, H_{T}>500, N_{jet}#geq3, MET>"+metcut, "Mu15_HT400",-1,1,true,false);
    // Electron, VVVL, fine binning
    PlotTurnOn(&c_met, "Max$(els_pt*(els_sigid&&els_miniso<0.1))", nbins,minx,maxx, "Electron p_{T}",
    	       "trig[33]&&onht>400&&ht>500&&njets>=3&&met>"+metcut, "trig[7]||trig[8]",
    	       "MET100, H_{T}>500, N_{jet}#geq3, MET>"+metcut, "Ele15_HT400",-1,1,true,false);
